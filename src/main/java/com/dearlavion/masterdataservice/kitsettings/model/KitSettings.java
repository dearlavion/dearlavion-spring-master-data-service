package com.dearlavion.masterdataservice.kitsettings.model;
 ...
 *
 * <p>Replaces the former {@code type_order} collection, which held only the order — see
 * KitSettingsMigration for the one-time copy.
 */
@Getter
@Setter
